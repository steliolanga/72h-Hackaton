    ...
    <div class="form-group">
     ...
     <div class="col-md-8">
      <sf:input type="text" path="firstName" class="form-control"
       ...
       <div class="form-group">
        <label class="control-label col-md-4">Apelido</label>
        <div class="col-md-8">
	   ...
	   <div class="form-group">
	     <label class="control-label col-md-4">Selecione previlegio</label>
	     <div class="col-md-8">
       ...
       <div class="form-group">
        <div class="col-md-offset-4 col-md-8">
			...
			>
				...
				Next - Endereco <span class="glyphicon glyphicon-chevron-right"></span>
