...
<!-- 		 <input -->
<!-- 			type="text" -->
<!-- 			style="width: 205px; padding: 7px; font-size: 12px; text-align: center; margin-left: 12%; border: 1px solid #0033a1" -->
<!-- 			; placeholder="Clique aqui para pesquisar" /> -->
	...
	<div class="menu-bar">
		...
		<ul>
			...
			<li><a href="${contextRoot}/show/all/products">Veiculos</a></li>

			<li><a href="${contextRoot}/contact">Contact</a></li>

			<li><a href="${contextRoot}/about">About</a></li>
			<li><a href="${contextRoot}/show/all/products">Veiculos</a></li>
			<li><a href="${contextRoot}/show/all/propriets">Casas</a></li>
			<li><a href="${contextRoot}/show/all/products">Veiculos</a></li>
			...
			<li id="listProducts"><a href="${contextRoot}/show/all/products">Veículos</a>
			</li>
